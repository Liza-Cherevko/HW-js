...
// addBtnEl.addEventListener('click', onAddContactBtnclick)
// // делегирование через tbody
// contactListEl.addEventListener('click', contactListClick)
...
// function editContact(id) {
//     const contactList = list.find((item) => item.id === id);
//     fillForm(contactList);
// }
